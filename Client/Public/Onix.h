...
class COnix : public CGameObj
{
private:
	COnix(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	COnix(const COnix& rhs);
	virtual ~COnix() = default;
...
public:
	static COnix* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
