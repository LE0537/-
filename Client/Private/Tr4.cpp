...
{
	m_vNormalScript.push_back(TEXT("»Â±‘±‘±‘±‘±‘±‘"));
	m_vNormalScript.push_back(TEXT("»Â»Â»Â§—§ßµÂµÂ±◊±∏±◊±◊±‘±‘"));
	m_vNormalScript.push_back(TEXT("»ÂÖæ»ÂêUÖæ!!!!!!!"));
...
void CTr4::Ready_LoseText()
{
	...
	wstring strTextBegin = TEXT("πŒ¡ÛπŒ¡Û §–§–...");
	m_vBattleScript.push_back(strTextBegin);
	m_vBattleScript.push_back(TEXT("¿Ø∑…¿«πË¡ˆ∏¶ æÚæ˙Ω¿¥œ¥Ÿ."));
}
void CTr4::OnNavi()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
