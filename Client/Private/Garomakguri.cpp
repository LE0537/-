...
void CGaromakguri::Reset_Battle()
{
	m_iAnim = 0;
	m_bSetPos = false;
	m_bBrath = false;
...
void CGaromakguri::Ready_WildBattle()
{
	m_vecPoke.reserve(6);;
...
void CGaromakguri::Ready_Script()
{
...
void CGaromakguri::Move(_float fTimeDelta)
{
...
void CGaromakguri::Set_Stats()
{
	...
	m_PlayerInfo.strName = TEXT("해월막구리");
	m_PlayerInfo.bEvent = false;
