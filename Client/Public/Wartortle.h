...
class CWartortle : public CGameObj
{
private:
	CWartortle(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CWartortle(const CWartortle& rhs);
	virtual ~CWartortle() = default;
...
public:
	static CWartortle* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
