...
class CBeat : public CGameObj
{
private:
	CBeat(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBeat(const CBeat& rhs);
	virtual ~CBeat() = default;
...
public:
	static CBeat* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
