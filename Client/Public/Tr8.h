...
class CTr8 : public CGameObj
{
private:
	CTr8(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTr8(const CTr8& rhs);
	virtual ~CTr8() = default;
...
public:
	static CTr8* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
