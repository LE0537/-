...
HRESULT CPikachu::Render_ShadowDepth()
{
	if (nullptr == m_pShaderCom ||
		nullptr == m_pModelCom)
		return E_FAIL;
...
void CPikachu::Race(_float fTimeDelta)
{
	if (m_iAnimIndex == 8)
	{
...
void CPikachu::Ready_WildBattle()
{
	m_vecPoke.reserve(6);;
...
void CPikachu::Move(_float fTimeDelta)
{
...
void CPikachu::Set_Stats()
{
	...
	m_PlayerInfo.strName = TEXT("ÇÇÄ«Ãò");
	m_PlayerInfo.bEvent = false;
