...
class CLickitung : public CGameObj
{
private:
	CLickitung(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CLickitung(const CLickitung& rhs);
	virtual ~CLickitung() = default;
...
public:
	static CLickitung* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
