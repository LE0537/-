...
class CChansey : public CGameObj
{
private:
	CChansey(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CChansey(const CChansey& rhs);
	virtual ~CChansey() = default;
...
public:
	static CChansey* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
