...
class CMew : public CGameObj
{
private:
	CMew(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CMew(const CMew& rhs);
	virtual ~CMew() = default;
...
public:
	static CMew* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
