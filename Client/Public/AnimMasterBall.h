...
class CAnimMasterBall : public CGameObj
{
private:
	CAnimMasterBall(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CAnimMasterBall(const CAnimMasterBall& rhs);
	virtual ~CAnimMasterBall() = default;
...
public:
	static CAnimMasterBall* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
