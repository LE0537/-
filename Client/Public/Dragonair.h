...
class CDragonair : public CGameObj
{
private:
	CDragonair(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CDragonair(const CDragonair& rhs);
	virtual ~CDragonair() = default;
...
public:
	static CDragonair* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
