...
class CTr4 : public CGameObj
{
private:
	CTr4(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTr4(const CTr4& rhs);
	virtual ~CTr4() = default;
...
public:
	static CTr4* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
