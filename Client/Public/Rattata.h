...
class CRattata : public CGameObj
{
private:
	CRattata(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRattata(const CRattata& rhs);
	virtual ~CRattata() = default;
...
public:
	static CRattata* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
