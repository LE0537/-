...
class CDratini : public CGameObj
{
private:
	CDratini(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CDratini(const CDratini& rhs);
	virtual ~CDratini() = default;
...
public:
	static CDratini* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
