...
class CTr9 : public CGameObj
{
private:
	CTr9(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTr9(const CTr9& rhs);
	virtual ~CTr9() = default;
...
public:
	static CTr9* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
