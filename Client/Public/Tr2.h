...
class CTr2 : public CGameObj
{
private:
	CTr2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTr2(const CTr2& rhs);
	virtual ~CTr2() = default;
...
public:
	static CTr2* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
