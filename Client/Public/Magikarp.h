...
class CMagikarp : public CGameObj
{
private:
	CMagikarp(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CMagikarp(const CMagikarp& rhs);
	virtual ~CMagikarp() = default;
...
public:
	static CMagikarp* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
