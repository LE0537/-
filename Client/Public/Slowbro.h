...
class CSlowbro : public CGameObj
{
private:
	CSlowbro(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CSlowbro(const CSlowbro& rhs);
	virtual ~CSlowbro() = default;
...
public:
	static CSlowbro* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
