...
class CBlastoise : public CGameObj
{
private:
	CBlastoise(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBlastoise(const CBlastoise& rhs);
	virtual ~CBlastoise() = default;
...
public:
	static CBlastoise* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
