...
class COlive : public CGameObj
{
private:
	COlive(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	COlive(const COlive& rhs);
	virtual ~COlive() = default;
...
public:
	static COlive* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
