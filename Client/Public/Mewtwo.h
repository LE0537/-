...
class CMewtwo : public CGameObj
{
private:
	CMewtwo(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CMewtwo(const CMewtwo& rhs);
	virtual ~CMewtwo() = default;
...
public:
	static CMewtwo* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
