...
class CButterfree : public CGameObj
{
private:
	CButterfree(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CButterfree(const CButterfree& rhs);
	virtual ~CButterfree() = default;
...
public:
	static CButterfree* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
