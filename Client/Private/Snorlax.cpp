...
HRESULT CSnorlax::Render_ShadowDepth()
{
	if (nullptr == m_pShaderCom ||
		nullptr == m_pModelCom)
		return E_FAIL;
...
void CSnorlax::Race(_float fTimeDelta)
{
	if (m_iAnimIndex == 8)
	{
...
void CSnorlax::Ready_WildBattle()
{
	m_vecPoke.reserve(6);;
...
void CSnorlax::Move(_float fTimeDelta)
{
