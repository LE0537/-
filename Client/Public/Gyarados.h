...
class CGyarados : public CGameObj
{
private:
	CGyarados(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CGyarados(const CGyarados& rhs);
	virtual ~CGyarados() = default;
...
public:
	static CGyarados* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
