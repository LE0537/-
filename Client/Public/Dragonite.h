...
class CDragonite : public CGameObj
{
private:
	CDragonite(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CDragonite(const CDragonite& rhs);
	virtual ~CDragonite() = default;
...
public:
	static CDragonite* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
