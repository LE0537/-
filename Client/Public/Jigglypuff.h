...
class CJigglypuff : public CGameObj
{
private:
	CJigglypuff(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CJigglypuff(const CJigglypuff& rhs);
	virtual ~CJigglypuff() = default;
...
public:
	static CJigglypuff* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
