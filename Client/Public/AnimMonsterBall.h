...
class CAnimMonsterBall : public CGameObj
{
private:
	CAnimMonsterBall(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CAnimMonsterBall(const CAnimMonsterBall& rhs);
	virtual ~CAnimMonsterBall() = default;
...
public:
	static CAnimMonsterBall* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
