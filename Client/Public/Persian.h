...
class CPersian : public CGameObj
{
private:
	CPersian(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPersian(const CPersian& rhs);
	virtual ~CPersian() = default;
...
public:
	static CPersian* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
