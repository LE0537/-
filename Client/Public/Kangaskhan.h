...
class CKangaskhan : public CGameObj
{
private:
	CKangaskhan(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CKangaskhan(const CKangaskhan& rhs);
	virtual ~CKangaskhan() = default;
...
public:
	static CKangaskhan* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
