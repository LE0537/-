...
class CTr7 : public CGameObj
{
private:
	CTr7(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTr7(const CTr7& rhs);
	virtual ~CTr7() = default;
...
public:
	static CTr7* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
