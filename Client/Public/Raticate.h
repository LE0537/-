...
class CRaticate : public CGameObj
{
private:
	CRaticate(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRaticate(const CRaticate& rhs);
	virtual ~CRaticate() = default;
...
public:
	static CRaticate* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
