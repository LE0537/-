...
class CTr0 : public CGameObj
{
private:
	CTr0(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTr0(const CTr0& rhs);
	virtual ~CTr0() = default;
...
public:
	static CTr0* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
