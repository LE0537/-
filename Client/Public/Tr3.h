...
class CTr3 : public CGameObj
{
private:
	CTr3(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTr3(const CTr3& rhs);
	virtual ~CTr3() = default;
...
public:
	static CTr3* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
